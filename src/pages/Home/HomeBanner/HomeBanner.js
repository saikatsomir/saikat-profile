...
const darkMood = () =>{
  ...
  element.classList.toggle("dark-thim")
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List style={{padding:'0px 20px'}}>
         ...
         <button style={button} onClick={darkMood}>  Dark Bood
</button><br/><br/><br/>
      ...
      >
        ...
        <Grid item xs={6} sm={7}>
            <Box><span style={{fontWeight:'550', fontSize:'30px'}}>Hi, There</span></Box>
